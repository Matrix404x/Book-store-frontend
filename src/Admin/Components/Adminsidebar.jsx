    ...
    <div>
      <div className="bg-blue-100 md:min-h-screen h-fit md:flex text-center flex-col py-10">
        <div className="flex justufy-center">
          <img style={{width:'100px', height:'100px', borderRadius:'50%'}} src="https://img.freepik.com/premium-vector/man-caharacter_665280-46970.jpg" alt="admin porfile" />
        </div>
        <h1 className='text-xl font-bold my-5' >adminName</h1>
        <div className="md:text-left mx-auto mt-10">
          <div className="mt-3">
            <Link to={'/admin'}> <CiHome /> Home </Link>
          </div>
          <div className="mt-3">
