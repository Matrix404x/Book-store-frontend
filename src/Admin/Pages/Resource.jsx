      ...
      <div className="md:grid grid-cols-5 gap-2">
        ...
        <div className="col-span-4 p-10">
          ...
          <div className="flex justify-center items-center my-8 font-medium text-lg">
            <p onClick={() => { setBookListStatus(true); setUserListStatus(false); }} className={bookListStatus ? 'text-blue-500 p-4 border-gray-200 border-t border-l border-r rounded cursor-pointer' : 'p-4 border-b border-gray-200 cursor-pointer'} >Books </p>
          ...
          {/* contents */}
          {
            ...
            <div className="md:grid grid-cols-4 w-full my-5">
              ...
              <div className="shadow rounded p-3 m-4">
                <img width={'100%'} height={'300px'} src="" alt="book" />
            ...
            <div className="md:grid grid-cols-3 w-full my-5">
              ...
              <div className="shadow rounded p-2 m-2 bg-gray-200">
                ...
                <div className="flex items-center mt-3">
                  <img width={'100px'} height={'100px'} src="https://img.freepik.com/premium-vector/man-character_665280-46970.jpg" alt="user" />
