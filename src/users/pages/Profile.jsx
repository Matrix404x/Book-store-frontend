  ...
  return (
    <>
      ...
      <div style={{ width: '230px', height: '230px', borderRadius: '50%', marginLeft: '70px', marginTop: '-130px' }} className="bg-white p-3">
        <img style={{ width: '200px', height: '200px', borderRadius: '50%' }} src="https://icon-library.com/images/username-icon-png/username-icon-png-14.jpg" alt="profile" />
      </div>
      ...
      <p className="md:px-20 px-5 my-5 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore voluptatibus qui inventore itaque autem mollitia quaerat, voluptas ea accusamus! Hic unde officia aliquid asperiores laboriosam rem facere non optio quibusdam! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laborum, doloribus aspernatur. Ullam vitae consequuntur optio, similique fugit rem autem alias minima. Aut alias, vitae repudiandae cumque ipsa quam qui deleniti Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis accusamus ipsam, maxime quam dolorum dolores assumenda voluptatibus eius eligendi voluptates inventore nulla vero deserunt voluptatem asperiores aliquam temporibus tempora! Deleniti?</p>

      {/* tabs */}
      <div className="md:p-40">
        <div className="flex justify-center items-center my-8 font-medium text-lg m-3">
          <p onClick={() => { setSellBookStatus(true); setBookStatus(false); setPurchaseStatus(false) }} className={sellBookStatus ? 'text-blue-500 p-4 border-gray-200 border-t border-1 border-r rounded cursor-pointer' : ' p-4 border-b border-gray-200 cursor-pointer '} >Sell Book Status</p>
          ...
          <div className="p-10 my-20 mx-5 bg-gray-200">
            ...
            <div className="md:grid grid-cols-2 mt-10 w-full">
              ...
              <div className="px-3">
                ...
                <div className="mb-3">
                  <input type="text" placeholder='Lamguage' className='w-full p-2 rounded placeholder-gray-400 text-black bg-white' />
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3 flex justufy-center items-center mt-10">
                  <label htmlFor="bookImage">
                    <input type="file" name='' id='bookImage' className='hidden' />
                    <img src="https://cdn.pixabay.com/photo/2016/01/03/00/43/upload-1118929_1280.png" alt="book" width={'200px'} height={'200px'} />
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 w-full flex md:justify-end justify-center mt-8">
              <button className='py-2 px-3 rounded bg-gray-600 text-white ms-3 hover:bg-white hover:border hover:text-black' >Reset</button>
              <button className='py-2 px-3 rounded bg-gray-600 text-white ms-3 hover:bg-white hover:border hover:text-black' >Submit</button>
            </div>
          </div>
        </div>
      }
      {/* book status */}
      {
        ...
        <div className="p-10 my-20 shadow rounded">
          ...
          <div className="p-5 roounded mt-4 bg-gray-100">
