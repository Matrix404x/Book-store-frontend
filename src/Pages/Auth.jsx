...
function Auth({ register }) {
  ...
  return (
    <>
      <div className="w-full min-h-screen flex justify-center items-center flex-col bg-[url('https://img.freepik.com/free-photo/open-book-more-books_23-2148213810.jpg')] bg-cover bg-center">
        <div className="p-10">
          <h1 className='text-3xl font-bold'>Book Store</h1>
          <div style={{ width: "400px" }} className="bg-black text-white p-5 flex flex-col justify-center items-center my-5">
            <div style={{ width: "100px", height: "100px", borderRadius: '80%' }} className='border mb-5 flex justify-center items-center' >
            ...
            <form className='my-5 w-full'>
              {
                register &&
                <input type="text" placeholder='Username' className='bg-white p-3 w-full rounded placeholder-gray-500 my-5 text-black' />
              }
              <input placeholder='Email ID' type="text" className='bg-white p-3 w-full rounded placeholder-gray-500 mb-5 text-black' />
              <div className="flex items-center">
                <input placeholder='Password' type={viewPasswordStatus ? "text" : "password"}
                  className='bg-white p-2 w-full rounded placeholder-gray-500 mb-3 text-black' />
                {!viewPasswordStatus ?
              ...
              <div className="my-5 text-center">
                {
                  register ?
                    <p className='text-blue-600'>Are you already a user? <Link to={'/login'}
                      className='undeline ms-5'>Login</Link></p>
                    :
                    <p>Are you a new user? <Link to={'/register'} className='underline ms-5' >Register</Link> </p>
                }
              </div>
            </form>
          </div>
